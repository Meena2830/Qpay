      ...
      <div className="grid md:grid-cols-4 gap-4">
        {cards.map((card, idx) => (
          <div key={idx} className="bg-lightGreen p-4 rounded-lg text-left">
            {/* Top row with icon + optional menu */}
...
<div className="grid md:grid-cols-2 gap-6 mt-6">
  ...
  <div className="p-6 border-2 rounded-lg shadow-md">
    <h3 className="font-medium text-lg mb-4 text-[#999999]">BUSINESS SERVICES</h3>
  ...
  <div className="p-6 border-2 rounded-lg shadow-md">
    <h3 className="font-medium text-lg mb-4 text-[#999999]">MANAGE BUSINESS</h3>
