    ...
    <div className="p-6 bg-gray-50 min-h-[calc(100vh-64px)] mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 flex flex-col h-full">
          <h3 className="text-xs font-semibold text-[#999999] uppercase mb-4 tracking-wide">
            Profile
          </h3>
        ...
        <div className="bg-white rounded-lg shadow p-6 flex flex-col h-full ">
          <h3 className="text-xs font-semibold text-gray-500 uppercase mb-4 text-[#999999]">
            QR
          </h3>
          ...
          <div className="flex items-center gap-6 flex-1">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-800 text-[#252525]">
                Order QR
              </p>
              <ul className="list-disc list-inside mt-2 text-sm text-[#999999] space-y-1 marker:text-gray-500">
                <li>
                  <span className="align-middle">Receive Payment</span>
                </li>
                <li>
                  <span className="align-middle">Order new QRs</span>
                </li>
                <li>
        ...
        <div className="bg-white rounded-lg shadow p-5">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="mt-1 font-bold text-gray-800 text-l">
                ₹1,23,816.19
              </h3>
            </div>
            <button
              ...
              .map((_, idx) => (
                <div key={idx} className="flex items-center justify-between">
                  <div className="leading-tight">
                    ...
                    <p className="fold-bold text-xs text-[#999999]">
                      23 Oct, 09:15 AM
                    </p>
                  </div>
        ...
        <div className="bg-white rounded-lg shadow p-5">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="mt-1 font-bold text-[#999999]text-lg">
                ₹1,23,816.19
              </h3>
            </div>
            <button
